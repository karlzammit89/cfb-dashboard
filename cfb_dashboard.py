...
if st.session_state.selected_cfbd_id:
    ...
    if USE_TM:
        sel_offenses = st.multiselect(
            "Offense",
            options=all_offenses,
            key="sel_offenses"
        )
    ...
    with clear_col:
        clear_filters = st.button("❌ Remove Filters", use_container_width=True)
